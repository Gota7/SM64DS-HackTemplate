...
SpawnInfo Thwomp::spawnData =
{
	[]() -> ActorBase* { return new Thwomp; },
	0x00a1,
	0x0047,
	0x02000002,
	0x00100000_f,
...
{
	model.mat4x3 = model.mat4x3.RotationXYZ(ang.x, ang.y, ang.z);
...
int Thwomp::InitResources()
{
	...
	clsn.SetFile(clsnF, clsnNextMat, COLISSION_RADIUS[thwompType], ang.y, *(CLPS_Block*)&clpsBlock);
